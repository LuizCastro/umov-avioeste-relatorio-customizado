...
function setData(data) {
    loading();
    // carregarComponentHTML("body", "components/capa.html");
                            ...
                            <table width="100%" class=" m-t-0 m-b-0">
                                ...
                                <tr>
                                    ...
                                    <div class="form-row">
                                            ...
                                            <span id="cpf">${data.municipio}</span>
                                    </div>
                                    <td style="width:30%">
                                        <div class="form-row">
                                                <span class="label">CEP:</span>
                                                <span id="cpf">${formatCEP(data.cep)}</span>
                                        </div>
                                    <td style="width:30%">
                                        <div class="form-row">
                                                <span class="label">UF:</span>
                                                <span id="cpf">${data.uf}</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
...
const formataA4 = () => {
    ...
    fetch('/components/_header.html')
        .then(res => res.text())
        .then(html => headerContentHTML = html);

    fetch('/components/_footer.html')
        .then(res => res.text())
        .then(html => footerContentHTML = html);
